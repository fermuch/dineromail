...
describe DineromailHelper do
  describe "#dineromail_button" do
    it 'should create a form with hidden fields' do
      ...
      generated_html.should have_selector('form') do
        have_selector "form input", :name => 'NombreItem', :type => 'hidden', :value => 'item name'
        have_selector "form input", :name => 'PrecioItem', :type => 'hidden', :value => '9.56'
      end
    end
  end
  ...
  describe "#dineromail_inputs" do
    ...
    it 'should accept an account_number option' do
      ...
      generated_html.should have_selector('input', :name => 'E_Comercio', :type => 'hidden', :value => '1234567')
    end
    
    it 'should accept a pay_methods option' do
      generated_html = helper.dineromail_inputs('item name',9.56, :pay_methods => '1')
      generated_html.should have_selector('input', :name => 'MediosPago', :type => 'hidden', :value => '1')
    end
    ...
    it 'should accept a currency option' do
      ...
      generated_html.should have_selector('input', :name => 'TipoMoneda', :type => 'hidden', :value => currency.to_s)
    end
    
    it 'should accept an item_number option' do
      generated_html = helper.dineromail_inputs('item name',9.56, :item_number => '1')
      generated_html.should have_selector('input', :name => 'NroItem', :type => 'hidden', :value => '1')
    end
